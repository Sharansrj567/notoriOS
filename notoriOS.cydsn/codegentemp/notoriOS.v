...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0\PulseConvert_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\PulseConvert_v1_0\PulseConvert_v1_0.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__Power_VBAT1_net;
	wire [0:0] tmpFB_0__Power_VBAT1_net;
	wire [0:0] tmpIO_0__Power_VBAT1_net;
	wire [0:0] tmpINTERRUPT_0__Power_VBAT1_net;
	electrical [0:0] tmpSIOVREF__Power_VBAT1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Power_VBAT1
		 (.oe(tmpOE__Power_VBAT1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Power_VBAT1_net[0:0]}),
		  .io({tmpIO_0__Power_VBAT1_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VBAT1_net),
		  .interrupt({tmpINTERRUPT_0__Power_VBAT1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VBAT1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Power_VBAT2_net;
	wire [0:0] tmpFB_0__Power_VBAT2_net;
	wire [0:0] tmpIO_0__Power_VBAT2_net;
	wire [0:0] tmpINTERRUPT_0__Power_VBAT2_net;
	electrical [0:0] tmpSIOVREF__Power_VBAT2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9145981d-9a04-4ebd-87f0-c7688c70b366"),
		  ...
		  .input_buffer_sel(2'b00))
		Power_VBAT2
		 (.oe(tmpOE__Power_VBAT2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Power_VBAT2_net[0:0]}),
		  .io({tmpIO_0__Power_VBAT2_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VBAT2_net),
		  .interrupt({tmpINTERRUPT_0__Power_VBAT2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VBAT2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Power_VDD1_net;
	wire [0:0] tmpFB_0__Power_VDD1_net;
	wire [0:0] tmpIO_0__Power_VDD1_net;
	wire [0:0] tmpINTERRUPT_0__Power_VDD1_net;
	electrical [0:0] tmpSIOVREF__Power_VDD1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("47595165-519b-4ff7-a407-25a37f27443d"),
		  ...
		  .input_buffer_sel(2'b00))
		Power_VDD1
		 (.oe(tmpOE__Power_VDD1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Power_VDD1_net[0:0]}),
		  .io({tmpIO_0__Power_VDD1_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VDD1_net),
		  .interrupt({tmpINTERRUPT_0__Power_VDD1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VDD1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Power_VDD2_net;
	wire [0:0] tmpFB_0__Power_VDD2_net;
	wire [0:0] tmpIO_0__Power_VDD2_net;
	wire [0:0] tmpINTERRUPT_0__Power_VDD2_net;
	electrical [0:0] tmpSIOVREF__Power_VDD2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1babd7b3-6ece-4b4c-8372-fa1e8ab19739"),
		  ...
		  .input_buffer_sel(2'b00))
		Power_VDD2
		 (.oe(tmpOE__Power_VDD2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Power_VDD2_net[0:0]}),
		  .io({tmpIO_0__Power_VDD2_net[0:0]}),
		  .siovref(tmpSIOVREF__Power_VDD2_net),
		  .interrupt({tmpINTERRUPT_0__Power_VDD2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Power_VDD2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpIO_0__AN_VSOL_net;
	wire [0:0] tmpINTERRUPT_0__AN_VSOL_net;
	electrical [0:0] tmpSIOVREF__AN_VSOL_net;
    ...
    UART_v2_50_2 Level_Sensor_UART (
        .clock(Net_37),
        .cts_n(1'b0),
        .reset(Net_26),
        .rts_n(Net_23),
        ...
        .tx_en(Net_24),
        .tx_interrupt(Net_28));
    defparam Level_Sensor_UART.Address1 = 0;
    defparam Level_Sensor_UART.Address2 = 0;
    defparam Level_Sensor_UART.EnIntRXInterrupt = 0;
    defparam Level_Sensor_UART.EnIntTXInterrupt = 0;
    defparam Level_Sensor_UART.FlowControl = 0;
    defparam Level_Sensor_UART.HalfDuplexEn = 0;
    defparam Level_Sensor_UART.HwTXEnSignal = 1;
    defparam Level_Sensor_UART.NumDataBits = 8;
    defparam Level_Sensor_UART.NumStopBits = 1;
    defparam Level_Sensor_UART.ParityType = 0;
    defparam Level_Sensor_UART.RXEnable = 1;
    defparam Level_Sensor_UART.TXEnable = 0;

	wire [0:0] tmpOE__Level_Sensor_RX_net;
	wire [0:0] tmpIO_0__Level_Sensor_RX_net;
	wire [0:0] tmpINTERRUPT_0__Level_Sensor_RX_net;
	electrical [0:0] tmpSIOVREF__Level_Sensor_RX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		Level_Sensor_RX
		 (.oe(tmpOE__Level_Sensor_RX_net),
		  .y({1'b0}),
		  .fb({Net_27}),
		  .io({tmpIO_0__Level_Sensor_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__Level_Sensor_RX_net),
		  .interrupt({tmpINTERRUPT_0__Level_Sensor_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Level_Sensor_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Level_Sensor_Power_net;
	wire [0:0] tmpFB_0__Level_Sensor_Power_net;
	wire [0:0] tmpIO_0__Level_Sensor_Power_net;
	wire [0:0] tmpINTERRUPT_0__Level_Sensor_Power_net;
	electrical [0:0] tmpSIOVREF__Level_Sensor_Power_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1d3c70fd-8070-402d-8547-2b180e698afb"),
		  ...
		  .input_buffer_sel(2'b00))
		Level_Sensor_Power
		 (.oe(tmpOE__Level_Sensor_Power_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Level_Sensor_Power_net[0:0]}),
		  .io({tmpIO_0__Level_Sensor_Power_net[0:0]}),
		  .siovref(tmpSIOVREF__Level_Sensor_Power_net),
		  .interrupt({tmpINTERRUPT_0__Level_Sensor_Power_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Level_Sensor_Power_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SD_Chip_Detect_net;
	wire [0:0] tmpFB_0__SD_Chip_Detect_net;
	wire [0:0] tmpIO_0__SD_Chip_Detect_net;
	wire [0:0] tmpINTERRUPT_0__SD_Chip_Detect_net;
	electrical [0:0] tmpSIOVREF__SD_Chip_Detect_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e89e1420-e4e7-4ff8-ab0f-f0de621df6ab"),
		  ...
		  .input_buffer_sel(2'b00))
		SD_Chip_Detect
		 (.oe(tmpOE__SD_Chip_Detect_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SD_Chip_Detect_net[0:0]}),
		  .io({tmpIO_0__SD_Chip_Detect_net[0:0]}),
		  .siovref(tmpSIOVREF__SD_Chip_Detect_net),
		  .interrupt({tmpINTERRUPT_0__SD_Chip_Detect_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SD_Chip_Detect_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam AMux.muxin_width = 8;
    defparam AMux.init_mux_sel = 8'h0;
    defparam AMux.one_active = 0;
	...
	wire [0:0] tmpINTERRUPT_0__AN_VBAT_net;
	electrical [0:0] tmpSIOVREF__AN_VBAT_net;
	...
	assign tmpOE__AN_VBAT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Debug_UART.HwTXEnSignal = 0;
	...
	wire [0:0] tmpOE__Pin_Telit_ONOFF_net;
	wire [0:0] tmpFB_0__Pin_Telit_ONOFF_net;
	wire [0:0] tmpIO_0__Pin_Telit_ONOFF_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Telit_ONOFF_net;
	electrical [0:0] tmpSIOVREF__Pin_Telit_ONOFF_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fe4241bd-04d2-457e-94bc-694d64a6b045"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Telit_ONOFF
		 (.oe(tmpOE__Pin_Telit_ONOFF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Telit_ONOFF_net[0:0]}),
		  .io({tmpIO_0__Pin_Telit_ONOFF_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Telit_ONOFF_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Telit_ONOFF_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Telit_ONOFF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Telit_pwr_net;
	wire [0:0] tmpFB_0__Pin_Telit_pwr_net;
	wire [0:0] tmpIO_0__Pin_Telit_pwr_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Telit_pwr_net;
	electrical [0:0] tmpSIOVREF__Pin_Telit_pwr_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("bca2924a-3d26-499c-9309-ebf06f06aadf"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Telit_pwr
		 (.oe(tmpOE__Pin_Telit_pwr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Telit_pwr_net[0:0]}),
		  .io({tmpIO_0__Pin_Telit_pwr_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Telit_pwr_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Telit_pwr_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Telit_pwr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Telit_SWRDY_net;
	wire [0:0] tmpFB_0__Pin_Telit_SWRDY_net;
	wire [0:0] tmpIO_0__Pin_Telit_SWRDY_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Telit_SWRDY_net;
	electrical [0:0] tmpSIOVREF__Pin_Telit_SWRDY_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Telit_SWRDY
		 (.oe(tmpOE__Pin_Telit_SWRDY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Telit_SWRDY_net[0:0]}),
		  .io({tmpIO_0__Pin_Telit_SWRDY_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Telit_SWRDY_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Telit_SWRDY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Telit_SWRDY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_7 UART_Telit (
        .clock(1'b0),
        .cts_n(1'b0),
        .reset(Net_185),
        .rts_n(Net_182),
    ...
    defparam UART_Telit.Address1 = 0;
    defparam UART_Telit.Address2 = 0;
    defparam UART_Telit.EnIntRXInterrupt = 0;
    defparam UART_Telit.EnIntTXInterrupt = 0;
    defparam UART_Telit.FlowControl = 0;
    defparam UART_Telit.HalfDuplexEn = 0;
    defparam UART_Telit.HwTXEnSignal = 1;
    defparam UART_Telit.NumDataBits = 8;
    defparam UART_Telit.NumStopBits = 1;
    defparam UART_Telit.ParityType = 0;
    defparam UART_Telit.RXEnable = 1;
    defparam UART_Telit.TXEnable = 1;
	...
	assign tmpOE__Rx_Telit_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_Telit_net;
	wire [0:0] tmpFB_0__Tx_Telit_net;
	wire [0:0] tmpIO_0__Tx_Telit_net;
	wire [0:0] tmpINTERRUPT_0__Tx_Telit_net;
	electrical [0:0] tmpSIOVREF__Tx_Telit_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8bcb5b2c-a2da-4aea-a098-64bb53c58a6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_Telit
		 (.oe(tmpOE__Tx_Telit_net),
		  .y({Net_180}),
		  .fb({tmpFB_0__Tx_Telit_net[0:0]}),
		  .io({tmpIO_0__Tx_Telit_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_Telit_net),
		  .interrupt({tmpINTERRUPT_0__Tx_Telit_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_Telit_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 Telit_ControlReg (
        .clock(1'b0),
        .control_0(Net_225),
        .control_1(Net_212),
        .control_2(Net_213),
        ...
        .control_7(Net_219),
        .reset(1'b0));
    defparam Telit_ControlReg.Bit0Mode = 0;
    defparam Telit_ControlReg.Bit1Mode = 0;
    defparam Telit_ControlReg.Bit2Mode = 0;
    defparam Telit_ControlReg.Bit3Mode = 0;
    defparam Telit_ControlReg.Bit4Mode = 0;
    defparam Telit_ControlReg.Bit5Mode = 0;
    defparam Telit_ControlReg.Bit6Mode = 0;
    defparam Telit_ControlReg.Bit7Mode = 0;
    defparam Telit_ControlReg.BitValue = 0;
    defparam Telit_ControlReg.BusDisplay = 0;
    defparam Telit_ControlReg.ExtrReset = 0;
    defparam Telit_ControlReg.NumOutputs = 1;

    // -- Mux start --
    if (1)
    begin : telit_mux
        reg  tmp__telit_mux_reg;
        always @(Net_222 or Net_223 or Net_225)
        begin
            case (Net_225)
                1'b0 :  tmp__telit_mux_reg = Net_222;
                1'b1 :  tmp__telit_mux_reg = Net_223;
            endcase
        end
        assign Net_180 = tmp__telit_mux_reg;
    end
    // -- Mux end --
	...
	wire [0:0] tmpFB_0__AN_PRTRANS_net;
	wire [0:0] tmpIO_0__AN_PRTRANS_net;
	wire [0:0] tmpINTERRUPT_0__AN_PRTRANS_net;
	electrical [0:0] tmpSIOVREF__AN_PRTRANS_net;

	cy_psoc3_pins_v1_10
		#(.id("3b87299f-c1f5-47ec-a2cd-b51aeda692b4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Valve2_POS_reading_net;
	wire [0:0] tmpFB_0__Valve2_POS_reading_net;
	wire [0:0] tmpIO_0__Valve2_POS_reading_net;
	wire [0:0] tmpINTERRUPT_0__Valve2_POS_reading_net;
	electrical [0:0] tmpSIOVREF__Valve2_POS_reading_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1342246d-aacd-4375-a9f9-10ee28b0ba01"),
		  ...
		  .input_buffer_sel(2'b00))
		Valve2_POS_reading
		 (.oe(tmpOE__Valve2_POS_reading_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Valve2_POS_reading_net[0:0]}),
		  .analog({Net_433}),
		  .io({tmpIO_0__Valve2_POS_reading_net[0:0]}),
		  .siovref(tmpSIOVREF__Valve2_POS_reading_net),
		  .interrupt({tmpINTERRUPT_0__Valve2_POS_reading_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Valve2_POS_reading_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Valve2_POS_Power_net;
	wire [0:0] tmpFB_0__Valve2_POS_Power_net;
	wire [0:0] tmpIO_0__Valve2_POS_Power_net;
	wire [0:0] tmpINTERRUPT_0__Valve2_POS_Power_net;
	electrical [0:0] tmpSIOVREF__Valve2_POS_Power_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8670dc7a-a8b2-47c1-bbab-4400d31d2e0e"),
		  ...
		  .input_buffer_sel(2'b00))
		Valve2_POS_Power
		 (.oe(tmpOE__Valve2_POS_Power_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Valve2_POS_Power_net[0:0]}),
		  .analog({Net_443}),
		  .io({tmpIO_0__Valve2_POS_Power_net[0:0]}),
		  .siovref(tmpSIOVREF__Valve2_POS_Power_net),
		  .interrupt({tmpINTERRUPT_0__Valve2_POS_Power_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Valve2_POS_Power_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("56ae33de-cdae-4136-8d8e-7d4caa91a01c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("06643876-143d-485d-be7e-388d042120c8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8477dac3-9389-436d-a7d9-625d79d10361"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpFB_0__Pin_Sampler_Completed_Sample_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_Sampler_Completed_Sample
		 (.oe(tmpOE__Pin_Sampler_Completed_Sample_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Sampler_Completed_Sample_net[0:0]}),
    ...
    PulseConvert_v1_0 PulseConverter (
        .out_clk(Net_1240),
        .p_in(Net_1308),
        .p_out(Net_1238),
        .sample_clk(Net_1237));
	...
	cy_clock_v1_0
		#(.id("1b0e0b71-4203-4d00-bea3-c0c4928ca3a0"),
	...
	cy_clock_v1_0
		#(.id("ec1f43d7-bdd1-4456-ae58-676c689fe44a"),
		  .source_clock_id("315365C3-2E3E-4f04-84A2-BB564A173261"),
		  .divisor(0),
    ...
    Counter_v3_0_8 BottleCounter (
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam BottleCounter.CaptureMode = 0;
    defparam BottleCounter.ClockMode = 0;
    defparam BottleCounter.CompareMode = 1;
    defparam BottleCounter.CompareStatusEdgeSense = 1;
    defparam BottleCounter.EnableMode = 0;
    defparam BottleCounter.ReloadOnCapture = 0;
    defparam BottleCounter.ReloadOnCompare = 0;
    defparam BottleCounter.ReloadOnOverUnder = 1;
    defparam BottleCounter.ReloadOnReset = 1;
    defparam BottleCounter.Resolution = 16;
    defparam BottleCounter.RunMode = 0;
    defparam BottleCounter.UseInterrupt = 1;

    assign Net_1194 = 1'h0;
