...
# Date: Sat, 26 Oct 2024 19:07:10 GMT
#set_units -time ns
...
create_generated_clock -name {FastClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 24001 48001} [list [get_pins {ClockBlock/dclk_glb_5}]]
create_generated_clock -name {SlowClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 240001 480001} [list [get_pins {ClockBlock/dclk_glb_6}]]
