...
void ReadyOrNot()
{
    ...
    snprintf(system_settings.ep_host,sizeof(system_settings.ep_host),"%s","lb-stormwater-89156408c3fcbe68.elb.us-east-1.amazonaws.com");
    
    // production server
    //snprintf(system_settings.ep_host,sizeof(system_settings.ep_host),"%s","malcom.open-storm.org");
    

    system_settings.ep_port = 4000;
